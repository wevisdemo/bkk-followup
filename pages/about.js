        ...
        <WvContainer>
          ...
          <WvParagraphGroup heading="เกี่ยวกับโปรเจกต์นี้">
            <div>
              ...
              ที่ใครหลายคนอาจจะยังไม่เข้าใจถึงระบบหรือการดำเนินการจัดการปัญหาต่าง
              ๆ ของกรุงเทพมหานคร
              <br />
              <br />
              ...
              ประกอบกับมีการจัดสรรงบประมาณเท่าไหร่ จัดการอย่างไร
              <br />
              <br />
              เพื่อให้ทุกคนได้รับรู้ข้อมูลได้อย่างชัดเจน ทางทีม
              จะพยายามอัปเดตข้อมูลให้เป็นปัจจุบันมากที่สุด
            </div>
          </WvParagraphGroup>
          ...
          <WvParagraphGroup heading="ที่มาของข้อมูล">
            <div className="b2">
              ...
              ได้แก่ สถิติที่รวบรวมไว้ในส่วนวิเคราะห์ข้อมูลเมือง ของ{" "}
              <a
                href="https://webportal.bangkok.go.th/pipd"
                target="_blank"
                rel="noopener noreferrer"
                className="b2 underline"
              >
                เว็บไซต์สำนักงานบริหารยุทธศาสตร์ สำนักยุทธศาสตร์และประเมินผล
                กรุงเทพมหานคร
              </a>
            </div>
            ...
            <div className="b3 hint">
              ...
              <ul className="ml-10 list-disc ">
                ...
                <li>
                  เรื่องพื้นที่สีเขียว จาก สำนักสิ่งแวดล้อม และ
                ...
                <li>
                  ...
                  >
                    ...
                    สำนักสิ่งแวดล้อม (2565 เป็นต้นไป)
                  </a>{" "}
                  สำนักยุทธศาสตร์และประเมินผล และกรมควบคุมมลพิษ
          ...
          <WvParagraphGroup heading="นโยบายการนำข้อมูลไปใช้ต่อ">
            <div className="b2">
              ...
              หรือมีข้อเสนอแนะใด ๆ สามารถติดต่อได้ที่ team{" "}
              <a
