...
export default function Dashboard(props) {
  ...
  if (selected_theme != null) {
    ...
    if (selected_theme.name === "น้ำท่วมถนน") {
      ...
      note =
        "ที่มาข้อมูล: สำนักสิ่งแวดล้อม สำนักยุทธศาสตร์และประเมินผล และสำนักงบประมาณ กรุงเทพมหานคร";
    } else if (selected_theme.name === "มลพิษในคลอง") {
      note =
        "ที่มาข้อมูล: สำนักจัดการคุณภาพน้ำ สำนักการระบายน้ำ สำนักยุทธศาสตร์และประเมินผล และสำนักงบประมาณ กรุงเทพมหานคร";
