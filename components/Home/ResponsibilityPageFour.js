  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto">
              ...
              <ul className="mt-5 list">
                {d.list.map((l, l_index) => (
                  ...
                  >
                    ...
                    <h4
                      className="flex-1 ml-3 text-lg leading-6"
        ...
        <div className="hidden mt-4 md:mt-10 lg:mt-4 2xl:mt-20 md:block">
          <b>ที่มา:</b>
          <ul className="list-disc pl-5 mt-1">
            <li>
              <b>อรทัย ก๊กผล. (2547). สารานุกรม การปกครองท้องถิ่นไทย หมวดที่ 3 พัฒนาการและรูปแบบ</b>
            </li>
            <li>
              <b>การปกครองท้องถิ่นไทย ลำดับที่ 5 เรื่อง กรุงเทพมหานคร. สถาบันพระปกเกล้า.</b>
            </li>
          </ul>
        </div>
      </div>
