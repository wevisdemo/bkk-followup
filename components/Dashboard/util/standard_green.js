...
const std_green = ({ selected_theme }) => {
  return (
    <div id="standard-green" className="flex flex-col justify-center mt-3 text-center card_cat_detail">
      <div
        id="gtk-header"
      ...
      >
        ...
        <p className="font-bold h4" style={{ color: selected_theme.text_color }}>
          9 ตร.ม./คน
        </p>
