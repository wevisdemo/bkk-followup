...
const line_chart = ({ selected_theme, data }) => {
  ...
  if (selected_theme.name === 'น้ำท่วมถนน') {
    ...
    note = 'ยิ่งระดับท่วมต่ำ ยิ่งดี และข้อมูลปี 2563 - 2564 รายงานสภาพน้ำท่วมขังบนถนนสายหลักที่อยู่ในความรับผิดชอบของสำนักการระบายน้ำเท่านั้น กรณีซอยย่อยต่างๆ ไม่ได้มีการจัดเก็บข้อมูล ';
    ...
    sub = 'ตั้งแต่ปี 2555-2563';
    dis = 'ค่่า BOD มาตรฐาน (ไม่เกิน 4 มก./ลิตร)';
    ...
    <div id="graph-trend" className="mt-3 card_cat_detail">
      ...
      <div className="px-2 py-3 leading-tight">
        ...
        <div id="line-chart-footer" className="flex flex-col items-center mt-4">
          ...
          <span className="flex max-w-lg mx-auto mt-2 p3">
