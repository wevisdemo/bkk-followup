...
const line_chart = ({ selected_theme, data }) => {
  ...
  if (selected_theme.name === "น้ำท่วมถนน") {
    ...
    note =
      "ยิ่งระดับท่วมต่ำ ยิ่งดี และข้อมูลปี 2563 - 2564 รายงานสภาพน้ำท่วมขังบนถนนสายหลักที่อยู่ในความรับผิดชอบของสำนักการระบายน้ำเท่านั้น กรณีซอยย่อยต่างๆ ไม่ได้มีการจัดเก็บข้อมูล ";
